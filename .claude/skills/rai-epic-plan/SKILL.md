...
### Step 6: Commit implementation plan

Commit the updated `scope.md` (plan section). Use exactly `Co-Authored-By: Rai <rai@humansys.ai>` (not model-vendor identities).

```bash
git add -A
git commit -m "docs(e{N}): epic implementation plan

{milestones or sequencing headline}

Co-Authored-By: Rai <rai@humansys.ai>"
```

<verification>
Plan section committed with Rai attribution trailer.
</verification>
...
- [ ] Plan section committed with `Co-Authored-By: Rai <rai@humansys.ai>`
