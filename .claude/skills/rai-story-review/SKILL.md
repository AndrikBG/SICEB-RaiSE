...
### Step 4b: Commit retrospective

Commit `s{N}.{M}-retrospective.md` (and any other files produced in this skill). Use exactly `Co-Authored-By: Rai <rai@humansys.ai>` (not model-vendor identities).

```bash
git add -A
git commit -m "docs(s{N}.{M}): story retrospective

{one line: outcome or key learning}

Co-Authored-By: Rai <rai@humansys.ai>"
```

<verification>
Retrospective committed with Rai attribution trailer.
</verification>
...
- [ ] Retrospective document created and committed with `Co-Authored-By: Rai <rai@humansys.ai>`
