...
### Step 6: Commit epic design artifacts

Commit scope, design (if any), new ADRs, and parking-lot updates as appropriate. Use exactly `Co-Authored-By: Rai <rai@humansys.ai>` (not model-vendor identities).

```bash
git add -A
git commit -m "docs(e{N}): epic design — scope and technical direction

{1-2 lines: story count, ADR count, or architecture headline}

Co-Authored-By: Rai <rai@humansys.ai>"
```

<verification>
Epic design artifacts committed with Rai attribution trailer.
</verification>
...
- [ ] Epic design artifacts committed with `Co-Authored-By: Rai <rai@humansys.ai>`
